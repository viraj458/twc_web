...
const ReadOnlyRow = ({contact, handleEditClick}) => {
  return (
    <>
        ...
        <td className=" mt-3 gap-2 text-xl flex"><div className='mr-4 ml-2'><button onClick={e=>handleEditClick(e, contact)}><MdEdit /></button></div><div><button><RiDeleteBin6Line /></button></div></td>
    </>
  )
}
